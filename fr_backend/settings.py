...
SECRET_KEY = 'django-insecure-8^qx72pac4_q!v)nv*2547opt5n0!2$o7w0uam&j(hoa@zs8pq'
...
# Configuration DRF et SimpleJWT
REST_FRAMEWORK = {
...
LOGGING = {
    ...
    'loggers': {
        ...
        'api.reports.management.commands.monitor_data': {
            'handlers': ['file', 'console'],
            'level': 'INFO',
            'propagate': True,
        },
